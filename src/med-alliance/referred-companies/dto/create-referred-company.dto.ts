...
export class CreateReferredCompanyDto {
  ...
  @ApiPropertyOptional({
    description: 'Additional description or notes about the company',
    example: 'Interested in virtual assistant services',
  })
  @IsOptional()
  @IsString()
  description?: string;
  ...
  @ApiPropertyOptional({
    description: 'UUID of the user to whom this referral is directed',
