...
export class CreateAffiliateProfileDto {
  @ApiProperty({
    description:
      'UUID of the existing platform user to create an affiliate profile for',
  ...
  @ApiPropertyOptional({
    description: 'HubSpot contact ID associated with this affiliate',
    example: '12345678',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description:
      'Default commission percentage (0-100) applied at detection time',
    example: 10.0,
    minimum: 0,
    maximum: 100,
  })
  ...
  @ApiPropertyOptional({
    ...
    example: 'Preferred transfer on the 1st of each month',
  })
  @IsOptional()
  @IsString()
