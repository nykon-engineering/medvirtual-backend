...
export class ListAffiliatesDto {
  ...
  @ApiPropertyOptional({ description: 'Filter by banking details completeness', enum: ['complete', 'incomplete'] })
  @IsOptional()
  @IsEnum(['complete', 'incomplete'])
  banking?: 'complete' | 'incomplete';

  @ApiPropertyOptional({ description: 'Filter by organization link status', enum: ['with_org', 'without_org'] })
  @IsOptional()
