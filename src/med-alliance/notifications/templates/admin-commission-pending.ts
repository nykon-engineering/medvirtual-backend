...
export interface AdminCommissionPendingPayload {
...
export function adminCommissionPendingTemplate(
...
<head>
  ...
  <title>Commission ready for review — ${payload.organizationName}</title>
  <style>
