    ...
    switch (event.associationType) {
      case 'COMPANY_TO_DEAL':
        ...
        if (!staff) {
          ...
          if (!newDeal) {
            console.log(
              'Impossible to create staff from dealCreation handler | Maybe this deal is not in the right pipeline',
            );
            return;
          }
        }
      ...
      case 'COMPANY_TO_CONTACT':
        ...
        if (!contact) {
          ...
          if (!newContact) {
            console.log(
              'Impossible to create contact from contactCreation handler | Maybe this contact is not in the right pipeline',
            );
            return;
          }
        }
