...
export const dbToOrganizationIndustryDictionary : Record<string, string> = Object.fromEntries(  
    Object.entries(organizationIndustryToDbDictionary).map(([key, value]) => [value, key])
);