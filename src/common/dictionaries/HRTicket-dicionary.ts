export const hrTicketToDbDictionary: Record<string, string> = {
  subject: 'title',
  content: 'description',
  ...
  other_shift_hours: 'other_shift_hours',
  ...
  background_requirements_of_candidate: 'background_requirements_of_candidate',

  //hire_date__start_of_employment_: 'expected_start_date', => issue form hubspot saying 'Enter a date before ${currentDate}':
};

export const dbToHrTicketDictionary: Record<string, string> =
  Object.fromEntries(
