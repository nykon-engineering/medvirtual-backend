...
export default function googleTokenExpired() {
  return `
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>The Google Token is Expired</title>
</head>
  ...
  <div style="max-width:600px;margin:0 auto;background-color:#ffffff;">
    ...
    <div style="padding:40px 30px;text-align:center;">
      <p style="color:#333333;font-size:18px;line-height:1.6;margin-bottom:56px;">
        Hi Paulo, we have detected that your google token is expired. Please reconnect your google account to continue using our services.
      </p>
