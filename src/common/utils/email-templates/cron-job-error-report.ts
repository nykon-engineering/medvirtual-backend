  ...
  <div style="max-width:650px;margin:0 auto;background-color:#ffffff;">
    ...
    <div style="padding:24px 24px 8px;">
      <div style="background-color:#fdecea;border-left:4px solid #c62828;padding:16px;border-radius:4px;margin-bottom:20px;">
        <p style="color:#c62828;font-size:16px;font-weight:700;margin:0 0 4px;">Cron Job Failed</p>
        <p style="color:#333;font-size:14px;margin:0;">The cron job <strong>${jobName}</strong> encountered an error on <strong>${formatDate(runAt)}</strong> and did not complete successfully.</p>
      </div>

      <h3 style="color:#181D27;margin-bottom:8px;">Error Message</h3>
      ...
      <p style="color:#555;font-size:14px;">Please investigate the issue and re-trigger the job manually if needed via <strong>GET /cron/${jobName}</strong>.</p>
    </div>
