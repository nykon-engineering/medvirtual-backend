...
export class UpdateHireRequestDto {
  ...
  @ApiProperty({
    example: 'English',
    description: 'The language required for this position',
    required: false,
    type: String,
  })
  @IsString()
  ...
  @ApiProperty({
    example: '1',
    description: 'The number of candidates required on this position',
    required: false,
    type: Number,
  })
  @IsNumber()
  ...
  @ApiProperty({
    example: 'Medical General',
    description: 'The position required on this position',
    required: false,
    type: String,
  })
  @IsString()
