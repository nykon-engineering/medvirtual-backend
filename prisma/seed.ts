...
async function main() {
  ...
  const emailTemplates = [
    ...
    },
    {
      ...
      body: 'The cron job {{jobName}} encountered an error on {{errorTime}} and did not complete successfully.\n\nError Message:\n{{errorMessage}}\n\nStack Trace:\n{{errorStack}}\n\nPlease investigate the issue and re-trigger the job manually if needed.',
      button_label: null,
      button_url: null,
    ...
    // ── System Alerts ─────────────────────────────────────────────────────────
    {
      ...
      body: "Hi {{recipientName}}, we have detected that your google token is expired. Please reconnect your google account to continue using our services.\n\nDon't worry about the system. We have a cron job that will reprocess all failed candidates every day.",
      button_label: null,
      button_url: null,
    ...
    },
    {
      ...
      body: "Hi {{recipientName}}, we have detected that your OpenAI account has insufficient quota to process further requests. Please review your OpenAI subscription and ensure you have enough credits to continue using our services.\n\nDon't worry about the system. We have a cron job that will reprocess all failed candidates every day.",
      button_label: null,
      button_url: null,
      placeholders: ['{{recipientName}}'],
    },
  ...
  console.log(`📧 EmailTemplates: ${created} created, ${updated} updated (total: ${emailTemplates.length})`);
