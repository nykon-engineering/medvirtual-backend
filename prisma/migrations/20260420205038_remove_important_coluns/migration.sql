/*
  ...
  - You are about to drop the column `eligibility_start_at` on the `Organization` table. All the data in the column will be lost.
  - You are about to drop the column `first_paid_invoice_at` on the `Organization` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Organization" DROP COLUMN "eligibility_start_at",
DROP COLUMN "first_paid_invoice_at";
