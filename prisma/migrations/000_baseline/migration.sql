...
-- CreateEnum
CREATE TYPE "ProcessingStatus" AS ENUM ('pending', 'processing', 'processing_downloadFile', 'processing_uploadFile', 'processing_extractData', 'processing_extractText', 'processing_organizeData', 'processing_updateCandidate', 'completed', 'failed');
