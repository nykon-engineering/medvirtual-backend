...
-- AlterTable
ALTER TABLE "Organization" ADD COLUMN     "refer_to_user_id" TEXT;

-- CreateIndex
CREATE INDEX "idx_organizations_refer_to_user" ON "Organization"("refer_to_user_id");

-- AddForeignKey
ALTER TABLE "Organization" ADD CONSTRAINT "Organization_refer_to_user_id_fkey" FOREIGN KEY ("refer_to_user_id") REFERENCES "USER"("id") ON DELETE SET NULL ON UPDATE CASCADE;
