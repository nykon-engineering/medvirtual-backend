...
*/
-- AlterEnum
ALTER TYPE "MedAllianceReferralStatus" ADD VALUE 'needs_admin_review';
...
-- AlterTable
ALTER TABLE "Organization" ADD COLUMN     "hubspot_sync_error" TEXT,
ADD COLUMN     "hubspot_sync_status" TEXT,
