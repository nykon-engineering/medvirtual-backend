/*
  ...
  - You are about to drop the column `description_summary` on the `HireRequest` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "HireRequest" DROP COLUMN "description_summary";
