...
*/
-- AlterEnum
ALTER TYPE "PayoutRequestStatus" ADD VALUE 'cancelled';

-- AlterTable
ALTER TABLE "AffiliatePayoutRequest" ADD COLUMN     "cancellation_reason" TEXT,
...
-- AddForeignKey
ALTER TABLE "AffiliatePayoutRequest" ADD CONSTRAINT "AffiliatePayoutRequest_cancelled_by_fkey" FOREIGN KEY ("cancelled_by") REFERENCES "USER"("id") ON DELETE SET NULL ON UPDATE CASCADE;
