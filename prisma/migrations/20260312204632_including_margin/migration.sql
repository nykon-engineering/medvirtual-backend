/*
  ...
  - You are about to drop the column `margin_per_hour` on the `PositionRateConfig` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "PositionRateConfig" DROP COLUMN "margin_per_hour",
ADD COLUMN     "berryVirtual_margin_per_hour" DECIMAL(65,30),
ADD COLUMN     "medVirtual_margin_per_hour" DECIMAL(65,30);
