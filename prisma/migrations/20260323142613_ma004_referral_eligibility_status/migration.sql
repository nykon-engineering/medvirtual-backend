...
*/
-- CreateEnum
CREATE TYPE "MedAllianceReferralStatus" AS ENUM ('eligible', 'not_eligible_active_client');
...
-- AlterTable
ALTER TABLE "Organization" ADD COLUMN     "med_alliance_block_reason" TEXT,
ADD COLUMN     "med_alliance_referral_status" "MedAllianceReferralStatus";
